...
class _NewCoursesListState extends State<NewCoursesList> {
  ...
  Widget newCourseTile(
      BuildContext context, Course details, Color bgColor, Color txtColor) {
...
//    int length = newCourses.length > 20 ? 20 : newCourses.length;
          ...
          itemBuilder: (context, idx) {
            if (widget._visible)
              return newCourseTile(
                  context, newCourses[idx], mode.tilecolor, mode.txtcolor);
            else
              return Container(
                width:

...
import '../Screens/fact_slider.dart';
import '../Screens/image_swiper.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget scaffoldView(UserProfile user, course, mode, bundleCourses, ) {
    ...
    var testimonialList = Provider.of<HomeDataProvider>(context).trustedList;
  ...
  Future<Null> getHomePageData() async {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      await wish.initDetails(context);

...
class _CourseDetailScreenState extends State<CourseDetailScreen>
  ...
  SliverAppBar appB(String category, FullCourse details,
      List<String> markedChpIds, bool isFav, bool isPur) {
    return SliverAppBar(
      elevation: 0,
                  ...
                  child: Align(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color:
                              tabselIdx == 0 ? Colors.black : Colors.grey[300],
                        ),
                      ))),
            ),
            InkWell(
                  ...
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      child: ListView.builder(
                        padding:
                            EdgeInsets.only(left: 12.0, bottom: 24.0, top: 5.0),
                        itemBuilder: (context, idx) =>
                            CourseListItem(relatedCourses[idx], true),
                        scrollDirection: Axis.horizontal,
                        itemCount: (relatedCourses.length ~/ 2).toInt(),
                      ),
                    ),
                  ),
                  //AboutTheInstructor
  ...
  Widget build(BuildContext context) {
    ...
    bool isFav = wish.checkForFav(apiData.id);
    double progress = 0.0;
    ...
    bool ispurchased =
        apiData.purchased || (apiData.type == "0" || apiData.type == 0);
    return Scaffold(
        key: _scaffoldKey,
        body: scaffoldBody(
          category,

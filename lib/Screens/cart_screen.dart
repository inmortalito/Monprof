...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget cartItemTabBundle(
      CartModel bundle, BuildContext ctx, String currency) {
    BundleCourses bundleDetails =
        Provider.of<BundleCourseProvider>(context, listen: false)
            .getBundleDetails(bundle);
    return Container(
      height: 125,
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(15.0),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: scaffoldView(cartCourses, currency, mode));
  }
}
